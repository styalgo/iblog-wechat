...
Page({
    ...
    onLoad: function (options) {
        ...
        var postUrl = app.globalData.URL + '/wechat/article/' + options.postId;
        var commentUrl = app.globalData.URL + '/wechat/comments/' + options.postId;
        ...
        //@todo 网络请求文章评论API数据
        request.requestGetApi(commentUrl, token, params, this, this.successComment, this.failFunRefreshPosts);

        //@todo 文章内容网络请求API数据
        request.requestGetApi(postUrl, token, params, this, this.successFunPost, this.failFunPost);
